      ...
      try {
        ...
        await db.nutritionPlan.create({
          data: {
            ...
            mealPlan: extractSection(fullContent, "MACRO TARGETS") ?? fullContent,
            snackSwaps: extractSection(fullContent, "DANGEROUS SNACKS & CALORIE TRAPS") ?? extractSection(fullContent, "DANGEROUS SNACKS"),
